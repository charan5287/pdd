...
# Generate remaining test cases up to 300 cleanly across modules
modules = [
...
# Detailed template topics for generating unique 300 test cases
templates = {
...
for mod_name, prefix, count in modules:
    ...
    for idx in range(1, count + 1):
        ...
        # Build description with clear Action, Expected Result, Status
        desc_text = (
            f"Verify {tmpl[0]}.\n"
...
# Truncate or ensure exactly 300 test cases
all_test_cases = all_test_cases[:300]
print(f'Total test cases compiled: {len(all_test_cases)}')

# List of target Excel files to update across the repository
target_files = [
    r'e:\Medicine\Test Results\Excel\Master_Comprehensive_Test_Report.xlsx',
    r'e:\Medicine\Test Results\Excel\Automation_Test_Report.xlsx',
    r'e:\Medicine\automation\reports\Excel\Master_Comprehensive_Test_Report.xlsx',
    r'e:\Medicine\automation\reports\Excel\Automation_Test_Report.xlsx',
]
...
def format_workbook(file_path):
    ...
    for ws in [ws1, ws2]:
        ...
        for r_idx, tc in enumerate(all_test_cases, 2):
            ...
            ws.row_dimensions[r_idx].height = 55 # Elevated height for multiline description
    ...
    wb.save(file_path)
    print(f'[SUCCESS] Successfully written 300 test cases to: {file_path}')
