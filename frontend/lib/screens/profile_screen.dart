                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildMenuCard([
                      ...
                      _MenuItem(Icons.info_outline_rounded, 'About MediNow',
                          Colors.teal, () {
                            showAboutDialog(context: context, applicationName: 'MediNow', applicationVersion: '2.0.0', applicationIcon: const Icon(Icons.favorite, color: AppColors.primary));
                          }),
                    ]),
                    const SizedBox(height: 24),
