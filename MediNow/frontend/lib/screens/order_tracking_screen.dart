        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(order['pharmacy_name'] ?? 'Pharmacy', style: TextStyle(color: Colors.grey.shade600)),
            ],
          ),
          const Spacer(),
          Column(
            ...
            children: [
              ...
              Text('₹${order['total']}', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.primary)),
            ],
          ),
        ],
      ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(order['partner'] ?? 'Rahul', style: const TextStyle(fontWeight: FontWeight.bold)),
                const Text('MediConnect Delivery Expert', style: TextStyle(fontSize: 12, color: Colors.grey)),
              ],
            ),
          ),
          IconButton(
            onPressed: () async {
              final phone = order['partner_phone']?.toString() ?? '';
              if (phone.isNotEmpty) {
  ...
  Widget _buildOrderDetails() {
    return Column(
      ...
      children: [
        ...
        Text(order['address'] ?? 'No address provided', style: TextStyle(color: Colors.grey.shade600)),
      ],
    );
  }
}
